...
ENVS_BASE="TDMA_DISABLED= TDMA_SLOT_NS=1048544 MPC_SO_PRIORITY=4 MPC_PAIR_KEY_SEED=200 MPC_NETWORK=eno1 ACCOUNTABILITY_ENABLE=1 ACCOUNTABILITY_F=1 ACCOUNTABILITY_W=1000 ACCOUNTABILITY_TAU=20 ACCOUNTABILITY_Q=2 TDMA_RETX_K_SEND=1000 TDMA_RETX_K_RECV=1000"
