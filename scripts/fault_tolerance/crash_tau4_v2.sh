...
ENVS_BASE="TDMA_DISABLED= TDMA_SLOT_NS=1048544 MPC_SO_PRIORITY=4 MPC_PAIR_KEY_SEED=200 MPC_NETWORK=eno1 ACCOUNTABILITY_ENABLE=1 ACCOUNTABILITY_F=1 ACCOUNTABILITY_W=30 ACCOUNTABILITY_TAU=4 ACCOUNTABILITY_TAU_R=1000000 ACCOUNTABILITY_Q=2 ACCOUNTABILITY_PROBE_NS=10000000 ACCOUNTABILITY_PROBE_INTERVAL_NS=5240000 TDMA_RETX_K_SEND=10000 TDMA_RETX_K_RECV=10000"
