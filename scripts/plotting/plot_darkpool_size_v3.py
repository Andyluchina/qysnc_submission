#!/usr/bin/env python3
"""v3 darkpool sweep: sync = docker-distributed code_host, qsync = TSN.
Two separate figures, one per app, sync vs qsync vs B."""
import os, csv
...
SUMMARY = "/root/e1_sweep/results/darkpool_size_sweep_v3/summary.tsv"
...
def plot_one(app_label, app_key, data, depth, out_path):
    ...
    for proto_label, proto_key, color, mark in [
        ("Sync TCP (docker, code_host)", "sync",  "#1f77b4", "o"),
...
if __name__ == "__main__":
    ...
    plot_one("CDA", "Darkpool_CDA", data, 7,
             "/root/e1_sweep/results/darkpool_size_sweep_v3_cda.png")
    plot_one("VM",  "Darkpool_VM",  data, 6,
             "/root/e1_sweep/results/darkpool_size_sweep_v3_vm.png")
